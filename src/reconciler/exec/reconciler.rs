...
pub trait Reconciler {
    type R;
    type T;
    type ExternalAPI: ExternalAPIShimLayer;

    spec fn well_formed(cr: &Self::R) -> bool;
    fn reconcile_init_state() -> Self::T;
    fn reconcile_core(cr: &Self::R, resp_o: Option<Response<<Self::ExternalAPI as ExternalAPIShimLayer>::Output>>, state: Self::T) -> (Self::T, Option<Request<<Self::ExternalAPI as ExternalAPIShimLayer>::Input>>)
